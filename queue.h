 ...
 * then splicing them back. It should only be called by 'do_shuffle'.
 * The function returns immediately if the list is NULL, empty, or singular.
 *
 * PRNG function will be called in this function. The default one is
 * 'randombytes'.
 *
